...
- **Desktop** — AMD Ryzen 9 9950X3D, ASUS ROG STRIX B850-G GAMING WIFI, RTX 5090.
...
| **Apps** | [apps/](apps/) — Packages, Enpass, Brave, VirtualBox, QGIS, TexLive, HP Printer, [Cider](apps/cider.md), [Sidra](apps/sidra.md), [Claude Code](apps/claude-code.md), [Claude Desktop](apps/claude-desktop.md), [Thunderbird/Betterbird MCP](apps/thunderbird-mcp.md), [Discord](apps/discord.md) |
| **Peripherals** | [peripherals/](peripherals/) — LAMZU Maya X, [Bluetooth](peripherals/bluetooth.md) (incl. SMSL AO300PRO amp reconnect), [XG27JCG dual-mode](peripherals/xg27jcg-dual-mode.md) + [image settings](peripherals/xg27jcg-image-settings.md), [Orico dock → TOSLINK optical (WiiM Vibelink amp)](peripherals/orico-dock-toslink.md) |
